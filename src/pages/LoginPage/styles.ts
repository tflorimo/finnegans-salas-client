...
const COLOR_AUTH_MODAL_BG = "#ffffff";
const COLOR_AUTH_MODAL_TITLE = "#000000ff";
const COLOR_AUTH_MODAL_TEXT = "#475569";
const COLOR_AUTH_MODAL_SHADOW = "rgba(15, 23, 42, 0.25)";
