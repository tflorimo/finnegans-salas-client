...
export const ROOM_PAGE_MESSAGES = {
  ...
  CHECK_IN_SUBTITLE: "Check-in disponible desde 30 minutos antes del inicio del evento hasta 15 minutos después de haber iniciado, si el check-in no es realizado, la sala continuará visualizándose como disponible.",
